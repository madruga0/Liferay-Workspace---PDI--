...
<%
    ...
    Double price = (Double) request.getAttribute("itemPrice");
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><%= (name != null) ? name : "Not informed" %></td>
                                <td><%= (price != null) ? price : "Not informed" %></td>
                                <td><%= (description != null) ? description : "Not informed" %></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
